package com.gmonetix.wallpapershdultimate.app;
...
public class AppConst {
    ...
    public static final String SDCARD_DIR_NAME = "WallpapersHD";

    // Picasa/Google web album username
    public static final String PICASA_USER = "gmonetixgallery";
